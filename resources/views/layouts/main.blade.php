        ...
        <div class="container-fluid">
            @auth
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex mb-0 mb-md-3 mb-lg-0" id="form-search">
                        <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="keywords" id="search-input">
    ...
    <script>
        const URLSEARCH = {
            ...
            set query(values) {
                ...
                throw TypeError('query string must be array of objects')
            }
        }
    </script>
